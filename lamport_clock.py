...
def internal_event(process):
    ...
    print(f"{process}: Internal Event -> Clock = {clock[process]}")
...
def receive_message(receiver, sender, message, timestamp):
    clock[receiver] = max(clock[receiver], timestamp) + 1
...
# 3. P2 performs an internal event
internal_event("P2")

# 4. P2 receives M1
receive_message("P2", "P1", "M1", m1_timestamp)

# 5. P2 sends M2 to P3
m2_timestamp = send_message("P2", "P3", "M2")

# 6. P3 performs an internal event
internal_event("P3")

# 7. P3 receives M2
receive_message("P3", "P2", "M2", m2_timestamp)

# 8. P3 sends M3 to P1
m3_timestamp = send_message("P3", "P1", "M3")

# 9. P1 receives M3
receive_message("P1", "P3", "M3", m3_timestamp)
